...
const LoginPopup = ({ setShowLogin, setIsAuthenticated, setIsAdmin }) => {
  ...
  const handleSignUp = () => {
    ...
    handleAuth("http://localhost:3001/api/auth/registerCliente", {
      nombre,
      correo,
      contraseña,
    });
  ...
  const handleLogin = () => {
    ...
    const url =
      userType === "Cliente"
        ? "http://localhost:3001/api/auth/loginCliente"
  ...
  return (
    <div className="login-popup">
      <form
        onSubmit={(e) => {
          e.preventDefault();
          currState === "Sign Up" ? handleSignUp() : handleLogin();
        }}
        ...
        {currState === "Login" ? (
          <>
            <p>
              ...
              <b onClick={() => handleStateChange("Sign Up")}>Crear Cuenta</b>
            </p>
            <p>
              ¿Eres administrador?{" "}
              <b onClick={() => handleUserTypeChange("Administrador")}>
          ...
          <>
            <p>
              ¿Ya tienes cuenta?{" "}
              <b onClick={() => handleStateChange("Login")}>Iniciar Sesion</b>
            </p>
            <p>
              ¿Eres administrador?{" "}
              <b onClick={() => handleUserTypeChange("Administrador")}>
